...
export const BlogPostsList: React.FC<BlogPostsListProps> = ({ websiteId, perPage = 6 }) => {
  ...
  return (
    <>
      <Helmet>
        <meta name="description" content="Artigos e insights sobre desenvolvimento web, tecnologia e soluções digitais." />
        <meta name="keywords" content="blog tecnologia, desenvolvimento web, artigos tech, mattos tech" />
      </Helmet>
